...
2. Train the VAE (see separate VAE repository).
3. Train both conditional and unconditional diffusion models with the 
   provided configs.
4. Generate samples and run evaluation scripts.
